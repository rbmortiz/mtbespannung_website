                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav">
                            <li className="nav-item">
                                <a className="nav-link" href="#" onClick={() => {siteSwitcherHandler(1)}}>Bespannungsservice</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="#" onClick={() => {siteSwitcherHandler(2)}}>Bespannungsinfos</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="#" onClick={() => {siteSwitcherHandler(3)}}>Trainerstunden</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="#" onClick={() => {siteSwitcherHandler(4)}}>Über-mich</a>
                            </li>
                        </ul>
                    </div>
                </nav>
